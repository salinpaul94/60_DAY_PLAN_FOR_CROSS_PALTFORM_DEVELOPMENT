...
**Example Explanation:**
This example sets up routing with multiple routes and navigation links using React Router. The `nav` element contains `Link` components for navigating to the Home, About, Services, and Contact routes. The `Routes` component renders the first matching `Route` based on the URL.
...
- **Routes:** The `Router`, `Route`, and `Routes` components manage the routing and navigation in the application.
