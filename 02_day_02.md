...
**Explanation:**
The spread operator (`...`) is a feature in ES6 that allows an iterable, such as an array or string, to be expanded in places where zero or more arguments or elements are expected. It enables easy copying and merging of arrays, as well as combining objects.
...
Practicing writing functions with rest parameters helps you understand how to work with dynamic arguments and simplifies the handling of variadic functions. It also reinforces the concept of array manipulation within functions.
...
**Example Explanation:**
This example defines a function `fetchData` that returns a promise. The promise resolves with the value "Data received" after 2 seconds. The `then` method is used to log the result when the promise is fulfilled.
